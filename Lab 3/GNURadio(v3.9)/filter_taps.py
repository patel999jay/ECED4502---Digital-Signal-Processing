...
class filter_taps(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Filter Introduction", catch_exceptions=True)
        ...
        self.lp_taps_value_no = lp_taps_value_no = print("\nThis is number of Low pass filter taps :- \t",len(firdes.low_pass(1, samp_rate, lp_cutoff, transition, window.WIN_HAMMING, 6.76)))
        self.lp_taps_value = lp_taps_value = print("\nThis is Low Pass coefficient : \t",firdes.low_pass(1, samp_rate, lp_cutoff, transition, window.WIN_HAMMING, 6.76))
        self.hp_taps_value_no = hp_taps_value_no = print("\nThis is number of High pass filter taps :- \t",len(firdes.high_pass(1, samp_rate, hp_cutoff, transition, window.WIN_BLACKMAN, 6.76)))
        self.hp_taps_value = hp_taps_value = print("\nThis is High Pass coefficient : \t",firdes.high_pass(1, samp_rate, hp_cutoff, transition, window.WIN_BLACKMAN, 6.76))
        self.bs_taps_value_no_0_0 = bs_taps_value_no_0_0 = print("\nThis is number of Band Stop filter taps:- \t",len(firdes.band_reject(1.0, samp_rate, bp_low, bp_high, transition, window.WIN_HANN, 6.76)))
        self.bs_taps_value_0 = bs_taps_value_0 = print("\nThis is Band Stop coefficient : \t", firdes.band_reject(1.0, samp_rate, bp_low, bp_high, transition, window.WIN_HANN, 6.76))
        self.bp_taps_value_no_0 = bp_taps_value_no_0 = print("\nThis is number of Band pass filter taps:- \t",len(firdes.band_pass(1.0, samp_rate, bp_low, bp_high, transition, window.WIN_RECTANGULAR, 6.76)))
        self.bp_taps_value = bp_taps_value = print("\nThis is Band Pass coefficient : \t", firdes.band_pass(1.0, samp_rate, bp_low, bp_high, transition, window.WIN_RECTANGULAR, 6.76))
        self.LP_Filter_Taps = LP_Filter_Taps = len(firdes.low_pass(1, samp_rate, lp_cutoff, transition, window.WIN_HAMMING, 6.76))
        self.HP_Filter_Taps = HP_Filter_Taps = len(firdes.high_pass(1, samp_rate, hp_cutoff, transition, window.WIN_BLACKMAN, 6.76))
        self.BS_Filter_Taps_0 = BS_Filter_Taps_0 = len(firdes.band_reject(1.0, samp_rate, bp_low, bp_high, transition, window.WIN_HANN, 6.76))
        self.BP_Filter_Taps = BP_Filter_Taps = len(firdes.band_pass(1.0, samp_rate, bp_low, bp_high, transition, window.WIN_RECTANGULAR, 6.76))

        ##################################################
        # Blocks
        ##################################################
        self._transition_range = Range(500, 15000, 100, 2000, 200)
        self._transition_win = RangeWidget(self._transition_range, self.set_transition, 'Transition width', "counter_slider", int, QtCore.Qt.Horizontal)
        ...
        self._lp_cutoff_win = RangeWidget(self._lp_cutoff_range, self.set_lp_cutoff, 'LP Cutoff', "counter_slider", int, QtCore.Qt.Horizontal)
        ...
        self._hp_cutoff_win = RangeWidget(self._hp_cutoff_range, self.set_hp_cutoff, 'HP Cutoff', "counter_slider", int, QtCore.Qt.Horizontal)
        ...
        self._bp_low_win = RangeWidget(self._bp_low_range, self.set_bp_low, 'BP Low-cutoff', "counter_slider", int, QtCore.Qt.Horizontal)
        ...
        self._bp_high_win = RangeWidget(self._bp_high_range, self.set_bp_high, 'BP High-cutoff', "counter_slider", int, QtCore.Qt.Horizontal)
    ...
    def set_transition(self, transition):
        ...
        self.set_BP_Filter_Taps(self._BP_Filter_Taps_formatter(len(firdes.band_pass(1.0, self.samp_rate, self.bp_low, self.bp_high, self.transition, window.WIN_RECTANGULAR, 6.76))))
        self.set_BS_Filter_Taps_0(self._BS_Filter_Taps_0_formatter(len(firdes.band_reject(1.0, self.samp_rate, self.bp_low, self.bp_high, self.transition, window.WIN_HANN, 6.76))))
        self.set_HP_Filter_Taps(self._HP_Filter_Taps_formatter(len(firdes.high_pass(1, self.samp_rate, self.hp_cutoff, self.transition, window.WIN_BLACKMAN, 6.76))))
        self.set_LP_Filter_Taps(self._LP_Filter_Taps_formatter(len(firdes.low_pass(1, self.samp_rate, self.lp_cutoff, self.transition, window.WIN_HAMMING, 6.76))))
        self.set_bp_taps_value(print("\nThis is Band Pass coefficient : \t", firdes.band_pass(1.0, self.samp_rate, self.bp_low, self.bp_high, self.transition, window.WIN_RECTANGULAR, 6.76)))
        self.set_bp_taps_value_no_0(print("\nThis is number of Band pass filter taps:- \t",len(firdes.band_pass(1.0, self.samp_rate, self.bp_low, self.bp_high, self.transition, window.WIN_RECTANGULAR, 6.76))))
        self.set_bs_taps_value_0(print("\nThis is Band Stop coefficient : \t", firdes.band_reject(1.0, self.samp_rate, self.bp_low, self.bp_high, self.transition, window.WIN_HANN, 6.76)))
        self.set_bs_taps_value_no_0_0(print("\nThis is number of Band Stop filter taps:- \t",len(firdes.band_reject(1.0, self.samp_rate, self.bp_low, self.bp_high, self.transition, window.WIN_HANN, 6.76))))
        self.set_hp_taps_value(print("\nThis is High Pass coefficient : \t",firdes.high_pass(1, self.samp_rate, self.hp_cutoff, self.transition, window.WIN_BLACKMAN, 6.76)))
        self.set_hp_taps_value_no(print("\nThis is number of High pass filter taps :- \t",len(firdes.high_pass(1, self.samp_rate, self.hp_cutoff, self.transition, window.WIN_BLACKMAN, 6.76))))
        self.set_lp_taps_value(print("\nThis is Low Pass coefficient : \t",firdes.low_pass(1, self.samp_rate, self.lp_cutoff, self.transition, window.WIN_HAMMING, 6.76)))
        self.set_lp_taps_value_no(print("\nThis is number of Low pass filter taps :- \t",len(firdes.low_pass(1, self.samp_rate, self.lp_cutoff, self.transition, window.WIN_HAMMING, 6.76))))
        self.band_pass_filter_0.set_taps(firdes.band_pass(1, self.samp_rate, self.bp_low, self.bp_high, self.transition, window.WIN_RECTANGULAR, 6.76))
        self.band_reject_filter_0.set_taps(firdes.band_reject(1, self.samp_rate, self.bp_low, self.bp_high, self.transition, window.WIN_HANN, 6.76))
        self.high_pass_filter_0.set_taps(firdes.high_pass(1, self.samp_rate, self.hp_cutoff, self.transition, window.WIN_BLACKMAN, 6.76))
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, self.lp_cutoff, self.transition, window.WIN_HAMMING, 6.76))
